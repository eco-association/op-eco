...
const L1_BRIDGE_ADDRESS = '0xDc64a140Aa3E981100a9becA4E685f962f0cF6C9'
const L1_ECO_ADDRESS = '0x3E87d4d9E69163E7590f9b39a70853cf25e5ABE3'
async function main() {
    let [l2Eco, l2Bridge, proxyAdminL2] = await deployL2(L2_OP_MESSANGER_ADDRESS, L1_BRIDGE_ADDRESS, L1_ECO_ADDRESS, SHARK_TEST_ACCOUNT_ADDRESS)
