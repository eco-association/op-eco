...
export const ERROR_STRINGS = {
  ...
  L1ERC20MintableBridge: {
    INVALID_L2_ADDRESS: 'L1ERC20MintableBridge: invalid L2 token address',
    INVALID_L1_ADDRESS: 'L1ERC20MintableBridge: invalid L1 token address',
